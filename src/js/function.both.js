...
exports.getRandom =function (min,max,{includedMin=true,includedMax=false,isInt=true}={}){
...
exports.getRandomItem =function (arrayLike){
    return  arrayLike[exports.getRandom(0,arrayLike.length)];
};

exports.debounce =function ({fn,idle=10,context=null,run=false}){
    var timer = null;

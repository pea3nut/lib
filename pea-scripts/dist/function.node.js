exports.formatDate =function formatDate(
    timestamp=new Date ,
...
exports.getRandom =function getRandom(min,max,{includedMin=true,includedMax=false,isInt=true}={}){
...
exports.getRandomChar =function getRandomChar(len){
...
exports.getRandomItem =function getRandomItem(arrayLike){
    let rand = Math.floor(Math.random() * arrayLike.length);
    return  arrayLike[rand];
};

exports.debounce =function debounce({fn,idle=10,context=null,run=false,runSync=false}){
    var timer = null;
